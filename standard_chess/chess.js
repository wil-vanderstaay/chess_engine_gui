...
let ROOK_MAGIC_NUMBERS = [
    BigInt("1000101010000000000100000100000000000000100000000000000000100000"),
    BigInt("000101000000000000000010000000000000000100000000000001000000"),
    BigInt("001010000000000110001000000010100000000000010111000000000001"),
    BigInt("000100000000000010000001000000000001000000000000010000100000"),
    BigInt("001000000000000000100000000000010000000010000000010000100000"),
    BigInt("001100000000000111000000000000000010000000010000000000001000"),
    BigInt("1000010010000000000000001000000000000010000000000000000100000000"),
    BigInt("0010000010000000000010001000000000000100010000000010100100000000"),
    BigInt("100000000000000010011000001000000100000000000000"),
    BigInt("0010000000100100010000000001000000000000001000000000000001000000"),
    BigInt("000100000000100000000010000000000000100000000001000000000000"),
    BigInt("000100100000100000000000100000000000100000000001000000000000"),
    BigInt("001000001000100000001000000010001000000000000000010000000000"),
    BigInt("0010100000000010001000000000100000000000010000000000"),
    BigInt("0010001000000000100000000000000100000000000000100000000010000000"),
    BigInt("100000000001000000000000000001100000100000100001000100000000"),
    BigInt("10000000000001000100000000000110010000100010000000000000"),
    BigInt("000100000000100000001000000000100000000000000100000000000000"),
    BigInt("0001001000010000100010100000000000010000001000000100001000000000"),
    BigInt("000101000000100001001000000000010000000000000000100000000010"),
    BigInt("010010000001100000101000000000010100000000000010100000000000"),
    BigInt("1000000010010100000000000100000000000010000000000100000100000000"),
    BigInt("0100000000010000000001000000000000010000000000010000100000000010"),
    BigInt("00100000000000001000100000000110000100000100"),
    BigInt("000100000000010000000000000010000000001000001000000000000000"),
    BigInt("0010000001000000000000000010000100100000000010000001000000000000"),
    BigInt("00100001001000000000011010000000000100000000000010000001"),
    BigInt("00100000000100000000000010000000000010000000000010000000"),
    BigInt("0010000000000000101000000000001000000000010000010000"),
    BigInt("00100000000010000000100000000000010000000000"),
    BigInt("10000000000010001000010000000000000100000000000100000010"),
    BigInt("10000000000000000100011000000000000001000010100010000001"),
    BigInt("0100000001000000000000001000000001000000100000000000000000100000"),
    BigInt("010001000000000000000011000000000000001000000000100000000001"),
    BigInt("0100001000000000000000010001000000000100010100000000"),
    BigInt("000110001000000000100000000000010000000100000000000100000000"),
    BigInt("00010100100000000000010000000001100000000010100000000000"),
    BigInt("0010000010000000000001000000000010000000100000000000001000000000"),
    BigInt("000100100100000010000000001000000100000000000001000000000001"),
    BigInt("001000000000000001000110010100000010000000000000010010000100"),
    BigInt("010010000000010000000000000010000000000010001000000000100000"),
    BigInt("0001000000000000010000100010000000010000000000110100000000000000"),
    BigInt("00110000001000000000000100000000000100010000000001000000"),
    BigInt("000100000000000000100001000000010000000000001001"),
    BigInt("0010000000000010000010000000000100000000000100010000000000000100"),
    BigInt("001000000010000000001000000000000100000000001000000000000010"),
    BigInt("00100000000000100000000000000100000000010000000100000000"),
    BigInt("0010000001001000010001000000000001000000100000100000000000000001"),
    BigInt("000100000001000000000010001000000000010000001000001000000000"),
    BigInt("01000000100000000010000000000000010000000001000010000000"),
    BigInt("0100000000001000000101000010000000000100010000010000000100000000"),
    BigInt("001000000110000010000010000011000000000100100000001000000000"),
    BigInt("0001000000000001000000000100000010000000000100000000"),
    BigInt("001000001100000000100000000010000000000001000000000010000000"),
    BigInt("0010100100110101011000010000100000110000000000100010010000000000"),
    BigInt("01000100010001000000000001000001000000001001001000000000"),
    BigInt("001010000000000000000001000001000000100000000010000100000001"),
    BigInt("0010000100000000000110010000000001000000000000000010000010000101"),
    BigInt("1000000011000000000010000100000100000000000100000010000000000001"),
    BigInt("0100000000100100000010000001000000000001000000000000010000100001"),
    BigInt("0010000000000011000010100000001001000100100001110010"),
    BigInt("00010010000000000001000000001000010000010100010000000010"),
    BigInt("001000000000011000010000010010010000000010100000100000000100"),
    BigInt("0001000000000100000010000001000000000010010000000010"),
];
let BISHOP_MAGIC_NUMBERS = [
    BigInt("01000000000001000000100001000100010000000100000010000100"),
    BigInt("00100000000001000010000010001010000000000100001000001000"),
    BigInt("00010000000110010000000001000001000010000000001000000010"),
    BigInt("000100001000000001100000100001000101000001000010000000010000"),
    BigInt("010110000001000100000100000110000000100000000000001000010000"),
    BigInt("0010000100010010000010000000010001000110001000000000000000010000"),
    BigInt("0001000010000000100000100000100000100000000001100000001000010000"),
    BigInt("001111000000100000001000010000010000001000100000001000000000"),
    BigInt("0100000001010000010000000100010001000000010000000100"),
    BigInt("00100001000000000001010000100000000010001000"),
    BigInt("0010010011010000000010000000100000000001000010000010000100000010"),
    BigInt("0001000000100000101000001010000000100000010000000000"),
    BigInt("01000000001100001000001000000000010000000010"),
    BigInt("0100000000010001000000000010000100000000100000000000"),
    BigInt("010000000001010010000100000100000100000100000100000000000101"),
    BigInt("100000000001000000010000010000000010000000100000001000000000"),
    BigInt("01000000000000100001000011000011100010000000000100000000"),
    BigInt("010000000100000000100010000000100100000100001000001000000000"),
    BigInt("100000010000000000011000001000000000001000000100000100000010"),
    BigInt("0100000000000010100000000001101000000010000000000011"),
    BigInt("10000101000001000000100000100000000010000000010000000000"),
    BigInt("1000000100000001000000101100100000001000100010000000010000000000"),
    BigInt("1110100100000000010000010000100010000100100000000000"),
    BigInt("1000000000000010000000100000010010000000100001000000000100000010"),
    BigInt("001000100000001000000000100001100101000010010000001000000001"),
    BigInt("0010000000010000000100000000101000000010000000100001001000000010"),
    BigInt("000101010010000001001000010000001000000000100010010000000001"),
    BigInt("00100000000010000000000000000010000010000001000100010000"),
    BigInt("0100000000000001000000000001000000100001000000000100000000000000"),
    BigInt("1000000000000000010000000100000000001010000000010001000000000010"),
    BigInt("11100100000000000100000010000001000000010001000000000010"),
    BigInt("00011100000000000100000000000001000000010010000010000000"),
    BigInt("1000000000000100001000000000100101100010101000000000001000100000"),
    BigInt("1000010000100010000100000000001000001000010100000000001000000010"),
    BigInt("0010000000000000010000000010001000000000001100000000110000001000"),
    BigInt("1000011001000110000000100000000010000000000010000000000010000000"),
    BigInt("1000000000000010000010100000001000000000000100000000100000001000"),
    BigInt("0010000000010000000000000100100010000000000100010001000000000000"),
    BigInt("0110001000110000000000001010000010000000000000010001010000000000"),
    BigInt("0100001000000000100011000000001101000000001000001001001000000010"),
    BigInt("001000001001000110001000001001000000000000000001000000000000"),
    BigInt("0100000000000100000010001010100010000100000000000001100000000000"),
    BigInt("00010001000001000000000010100110000010000000010000000000"),
    BigInt("0001100001000000000001100000101001000100000000100000100000000000"),
    BigInt("10010000000010000000000100000100000000000000000001000001"),
    BigInt("001000000001000000010001000000000000100000001000000100000001"),
    BigInt("0001101000100010000010000000100000000101000001001111000010000000"),
    BigInt("1000000000010010000000100000011000000000001000010001001000010010"),
    BigInt("010100000000100001100001000000010001001001000000000000000000"),
    BigInt("000110000000100000000110000100001000001000000000100000000000"),
    BigInt("0100000000000000000000100000111000000001000001000000000001000100"),
    BigInt("0011000000000000000000000010011000010000010001000000000000001010"),
    BigInt("100000000010001001000001000100000010000000100000000000000010"),
    BigInt("00100000100100000110000001100001001000010000000000000001"),
    BigInt("0101101010000100100001000001000000000100000000010000001100010000"),
    BigInt("0100000000010000100000000001000000010001110000000100"),
    BigInt("1010000000010000000100001001010100000010001000000000"),
    BigInt("0100101000000010000000010010000000000000"),
    BigInt("0101000000000010000000010000000100000000100110001011000000101000"),
    BigInt("1000000001000000000000000010100000010001000001000000100100000000"),
    BigInt("00101000000000000000000000010000000000100000001000000100"),
    BigInt("011000000000000000000010000000100000001011010000001001000000"),
    BigInt("1000100100011000100001000100100001000010000010000010001000000000"),
    BigInt("0100000000010000000000010001000000101001000000100000000000100000"),
];
    ...
    function slider_attacks() {
        ...
        for (let i = 0; i < 64; i++) {
            ...
            for (let index = 0; index < (1 << b_att_mask_count); index++) {
                ...
                let magic_str = (BigInt(print_bitboard(occupancy, false)) * b_magic_number).toString(2);
            ...
            for (let index = 0; index < (1 << r_att_mask_count); index++) {
                ...
                let magic_str = (BigInt(print_bitboard(occupancy, false)) * r_magic_number).toString(2);
...
function bishop_attack_fly(square, blockers) {
    ...
    let magic_str = (BigInt(print_bitboard(res, false)) * BISHOP_MAGIC_NUMBERS[square]).toString(2);
...
function rook_attack_fly(square, blockers) {
    ...
    let magic_str = (BigInt(print_bitboard(res, false)) * ROOK_MAGIC_NUMBERS[square]).toString(2);
